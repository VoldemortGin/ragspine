/**
 * Inline SVG icon set (lucide-style, stroke 1.5, currentColor).
 * No icon library dependency — add icons here as needed.
 */
...
export function IconListFilter(props: IconProps) {
  return (
    <Svg {...props}>
      <path d="M3 6h18" />
      <path d="M7 12h10" />
...
export function IconRedo(props: IconProps) {
  return (
    <Svg {...props}>
      ...
      <path d="M20 9H9.5a5.5 5.5 0 0 0-5.5 5.5a5.5 5.5 0 0 0 5.5 5.5H13" />
    </Svg>
  );
}
