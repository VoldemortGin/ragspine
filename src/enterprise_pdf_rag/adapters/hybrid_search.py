...
(ADR 0016). A single-channel mode is expressed as a fusion with one empty ranking, so every
...
class HybridSearch:
    ...
    def search(
        ...
        *,
        ...
        """Rank over the channels ``mode`` selects; ``auto`` classifies the query (ADR 0016).
