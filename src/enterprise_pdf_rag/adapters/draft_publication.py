...
class DraftQualification(BoundaryModel):
    ...
    retrieval_status: Literal["qualified; indexing pending"] = (
        "qualified; indexing pending"
    )
...
class DraftIndex(BoundaryModel):
    ...
    activated: Literal[False] = False
    retrieval_status: Literal["indexed; publication pending"] = (
        "indexed; publication pending"
    )
    review_path: str
