...
- A table grid (ADR 0014) and a diagram or formula (ADR 0015) become retrievable only through a model-free, replayable proof against the page's own rulings, shapes and characters; one failed rule withholds the whole object with a verbatim diagnostic.
