...
3. [ADR 0009](../../docs/enterprise-pdf-rag/adr/0009-source-qualified-expense-ratio-bar-lookup.md),
   ...
   [ADR 0016](../../docs/enterprise-pdf-rag/adr/0016-page-context-window.md)
...
processing/   pure page-processing / qualification logic; context_builder.py (evidence blocks
              ...
              beside — ADR 0016), table_transcription.py (literal table transcription rule),
...
answers/      pure answer chain — ports.py (MountedDocument, MemberText), models.py
              ...
              in the diagram reading order — ADR 0016), query_filters.py / member_filter.py
...
- **Page context informs, it never cites** (ADR 0016) — beside each hit the prompt prints the
