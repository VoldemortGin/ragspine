...
第一个真实 VectorStore adapter（见 src/ragspine/retrieval/docs/vector-store.md 的 adapter #1）。
...
默认 :memory: 无此问题，落盘用法的护栏见 src/ragspine/retrieval/docs/vector-store.md 的持久化增量。
"""
