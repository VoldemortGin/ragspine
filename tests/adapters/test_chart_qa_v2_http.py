...
from tests.figures.test_chart_qa import PinnedResolver, qualified_context
from tests.figures.test_chart_qa_displayed import DisplayedResolver, displayed_context
...
def test_explicit_v2_lookup_has_its_own_scoped_response_and_original_occurrences() -> (
    None
):
    ...
    async def exercise() -> None:
        async with AsyncClient(
            ...
            crossed = await client.post(
                "/v1/queries", json={**base, "snapshot_id": "f" * 64}
            )
