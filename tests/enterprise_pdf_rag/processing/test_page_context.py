...
def test_page_context_requires_real_distinct_occurrences_and_parent_graph_is_acyclic() -> None:
    ...
    with pytest.raises(ValueError, match="ownership"):
        validate_partition(page, replace(partition, unassigned_span_ids=("footer", "mark")))
    ...
    with pytest.raises(ValueError, match="cycle"):
        validate_partition(page, replace(partition, objects=(replace(chart, parent_id="chart"),)))
