...
def test_cached_source_processes_only_first_twenty_and_records_failure(
    ...
    class Objects:
        def process(self, _page: PageInput, _item: LayoutObject) -> ObjectProcessingRecord:
    ...
    assert called == [3]  # Successful layout outputs are reused; the failure is explicit.
