...
def test_slot_state_rejects_ambiguous_origin(
    state: SlotState, origin_cell_id: str | None
) -> None:
...
def test_inferred_table_cells_cannot_claim_independent_verification() -> None:
