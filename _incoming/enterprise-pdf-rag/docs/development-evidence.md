...
covers: src/enterprise_pdf_rag/adapters/pdfspine_figure.py, src/enterprise_pdf_rag/adapters/runtime.py, src/enterprise_pdf_rag/adapters/http/app.py, src/enterprise_pdf_rag/figures/service.py, tests/adapters/test_entries.py
